...
class MainTest(unittest.TestCase):
	...
	def test_works_with_conditional_intervals_going_over_midnight(self):
	...
	def test_fails_with_conditional_intervals_not_exclusive_over_midnight(self):
		ohRanges = ["17:00-03:00"];
		interval = 10;
